          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="javascript:void(0);" onclick="formularios(1);"><i class="fa fa-plus"></i>Agregar Usuario</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Permisos Usuarios</a></li>
              </ul>
            </li>
        ...
        <section class="content" id="contenido_principal">
          ...
          <div style="display: none;" id="cargador" align="center">
              ...
              <label style="color:#FFF; background-color:#ABB6BA; text-align:center"></label>
                <center>
              <img src="imagenes/empresa/espera.gif" alt="cargador" width="148" height="80"><label style="color:#ABB6BA"></label>
                </center>
              <br>
